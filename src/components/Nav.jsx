...
export default function Nav({show}){
    ...
    const activeLink = inactiveLink+" highlight text-black rounded-md ";
    ...
    const logout = async ()=>{
        const response = await fetch("https://gadgetmart.runasp.net/api/gadgetmart/logout",{
            method: "GET",
            credentials: "include"
        });
    ...
    return(
        <aside className={(show?'left-0':'-left-full')+" top-0 bgGray p-4 fixed w-full bgGray h-full  md:static md:w-auto transition-all"}>
